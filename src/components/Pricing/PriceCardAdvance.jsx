...
function PriceCardAdvance({ title, price, text1, text2, text3, text4 }) {
  return (
    <div className="relative overflow-hidden rounded-2xl ring-2 ring-green">
      <div className="absolute top-8 -left-9 h-7 w-40 -rotate-45 bg-green"></div>
